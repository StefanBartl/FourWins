...
headline_p.innerText = 'Spiele gegen deine Freunde oder gegen die CPU!';
...
aniToggle__h.innerText = 'Menü-Farbanimation abschalten';
aniToggle_checkbox.title = 'Schalte die farbige Menü-Animation auf/ab wenn das Menu eingeklappt ist';
...
headline_p.innerText = 'Play against friends or CPU!';
...
aniToggle__h.innerText = 'Toggle Menu colour-animation';
aniToggle_checkbox.title = 'Turn on/off the colored menu animation if settings-menu is collapsed';
